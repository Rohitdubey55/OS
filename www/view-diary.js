...
.dr-context-chips { display:flex; flex-wrap:wrap; gap:5px; margin-bottom:10px; }
  ...
  document.getElementById('main').innerHTML = `
    ...
    <div class="dr-shell">
      ...
      <!-- Overview Row: This Week + Mood Sparkline -->
      <div class="dr-overview-row">
        <div class="dr-overview-card">
        ...
        <div class="dr-overview-card">
          ...
          <div class="mood-sparkline" style="height:50px;">
            <canvas id="moodSparkline"></canvas>
          </div>
          <div class="dr-mood-insight">
            ${moodStats.peak ? `Best: ${moodStats.peak.day} · ${moodStats.peak.mood}/10` : 'Write to see trends'}
          </div>
        </div>
      </div>
  ...
  return `
    <div class="dr-insights">
      ...
      <div class="dr-insight-card">
        <div class="dr-insight-card-label">Mood Over Time</div>
        <canvas id="insightsChart" style="width:100%;height:120px;"></canvas>
      </div>
