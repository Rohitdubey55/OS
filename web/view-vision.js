...
async function renderVision() {
  ...
  // filter row + view-toggle row so the goals grid is the page.
      ...
      <div class="vz-head">
        ...
        <div class="vz-head__bar">
          ...
          <div class="vz-head__secondary">
            ...
            <button class="vz-mini-btn" onclick="routeTo('tdp')">10 Days Plan</button>
          </div>
        </div>
      </div>`;

  // MOBILE: unchanged stacked layout (overview card + filters + tabs).
  const _vzHeadMobile = `
      <div class="vz-ov">
