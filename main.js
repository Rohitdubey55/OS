...
window.state = {
    ...
    data: { planner: [], tasks: [], expenses: [], habits: [], habit_logs: [], diary: [], vision: [], settings: [], funds: [], assets: [], people: [] },
...
async function loadAllData() {
    ...
    const sheets = ['planner_events', 'tasks', 'expenses', 'habits', 'habit_logs', 'diary', 'vision_board', 'settings', 'funds', 'assets', 'people'];
    const keys = ['planner', 'tasks', 'expenses', 'habits', 'habit_logs', 'diary', 'vision', 'settings', 'funds', 'assets', 'people'];
...
// Start on init
setTimeout(startNotificationService, 2000);